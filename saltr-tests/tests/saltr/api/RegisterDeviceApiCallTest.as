...
/**
 * The RegisterDeviceApiCallTest class contain the RegisterDeviceApiCall tests
 */
public class RegisterDeviceApiCallTest extends ApiCallTest {
    ...
    public function RegisterDeviceApiCallTest() {
        super(ApiFactory.API_CALL_REGISTER_DEVICE);
    }
