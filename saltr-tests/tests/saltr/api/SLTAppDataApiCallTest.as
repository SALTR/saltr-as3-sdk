...
/**
 * The SLTAppDataApiCallTest class contain the AppDataApiCall tests
 */
public class SLTAppDataApiCallTest extends SLTApiCallTest {
    ...
    public function SLTAppDataApiCallTest() {
        super(SLTApiCallFactory.API_CALL_APP_DATA);
    }
