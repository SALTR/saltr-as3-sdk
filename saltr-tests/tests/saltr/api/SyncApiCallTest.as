...
/**
 * The SyncApiCallTest class contain the SyncApiCall tests
 */
public class SyncApiCallTest extends ApiCallTest {
    ...
    public function SyncApiCallTest() {
        super(ApiFactory.API_CALL_SYNC);
    }
