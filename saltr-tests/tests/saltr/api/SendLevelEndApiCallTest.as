...
/**
 * The SendLevelEndApiCallTest class contain the SendLevelEndApiCall tests
 */
public class SendLevelEndApiCallTest extends ApiCallTest {
    ...
    public function SendLevelEndApiCallTest() {
        super(ApiFactory.API_CALL_SEND_LEVEL_END);
    }
