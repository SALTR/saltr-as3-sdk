...
/**
 * The WebRegistrationDialog class represents the web registration dialog.
 * @private
 */
public class WebRegistrationDialog extends RegistrationDialog {
    /**
     ...
     */
    public function WebRegistrationDialog(flashStage:Stage) {
        super(flashStage);
    }
