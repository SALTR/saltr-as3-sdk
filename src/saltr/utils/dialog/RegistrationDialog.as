...
/**
 * The RegistrationDialog class represents the registration dialog.
 * @private
 */
public class RegistrationDialog extends Sprite {
    /**
     ...
     */
    public function RegistrationDialog(flashStage:Stage) {
