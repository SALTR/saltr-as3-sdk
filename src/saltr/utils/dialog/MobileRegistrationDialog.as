...
/**
 * The MobileRegistrationDialog class represents the mobile registration dialog.
 * @private
 */
public class MobileRegistrationDialog extends RegistrationDialog {
     ...
     */
    public function MobileRegistrationDialog(flashStage:Stage) {
        super(flashStage);
    }
